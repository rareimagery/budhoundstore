...
export default function EarthyOrganicStorefront() {
    ...
    <>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 72 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 10, color: "#BCAAA4", letterSpacing: "0.12em", textTransform: "uppercase", fontWeight: 300 }}>Natural · Organic · Trusted</p>
            </div>
          </div>
      ...
      <main style={{ maxWidth: 1200, margin: "0 auto", padding: "32px 32px 64px" }}>
        ...
        <div style={{
          ...
          <div style={{
            position: "absolute", top: -30, right: -20, fontSize: 200, opacity: 0.06,
            transform: "rotate(-15deg)"
          }}>🍃</div>
          <p style={{ fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", color: "#5D4037", fontWeight: 600, marginBottom: 12 }}>FROM SEED TO SOUL</p>
          <h2 style={{ fontSize: 36, fontWeight: 400, fontFamily: "'Playfair Display', serif", color: "#3E2723", marginBottom: 12, lineHeight: 1.2 }}>
            Nature's Pharmacy,<br /><span style={{ fontStyle: "italic" }}>Thoughtfully Curated</span>
          </h2>
          <p style={{ fontSize: 15, color: "#5D4037", maxWidth: 460, lineHeight: 1.7, fontWeight: 300 }}>
            Sun-grown, organically cultivated cannabis from California's Central Coast. Every product tells a story of care.
          </p>
        </div>

        {/* Mood Selector */}
        <div style={{ marginBottom: 32 }}>
          <p style={{ fontSize: 11, color: "#BCAAA4", letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 12, fontWeight: 600 }}>How are you feeling?</p>
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            {MOODS.map(mood => (
              <button key={mood.name} onClick={() => selectMood(mood)} style={{
                display: "flex", alignItems: "center", gap: 8,
                padding: "12px 22px", borderRadius: 50,
                border: "1px solid",
                borderColor: activeMood === mood.name ? "#6D4C41" : "#E8DFD3",
                background: activeMood === mood.name ? "#6D4C41" : "#FFFDF9",
                color: activeMood === mood.name ? "#FFFDF9" : "#6D4C41",
        ...
        <footer style={{ marginTop: 80, paddingTop: 32, borderTop: "1px solid #E8DFD3", display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
          <div>
            <p style={{ fontSize: 16, fontFamily: "'Playfair Display', serif", color: "#3E2723", marginBottom: 6 }}>🌱 Lompoc Valley Cannabis</p>
